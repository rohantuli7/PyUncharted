...
class Pyramid2():
    def __init__(self, map, startpoint, mapDesc, bag):
        ...
        # Options available
        self.options = ["Burn the map with the torch", "Rub the wall with the map", "Eat the map"]

        # Map of the second pyramid room
    ...
    def finalMission(self):
        ...
        self.text1 = tk.Label(self.win, text = "The path ahead is not visible with the current flame.",bg='black',fg='red')
        ...
        self.button1_1 = tk.Button(self.win, text = "Burn the map",bg='#567', fg='White', command = self.Mission)
        self.button1_2 = tk.Button(self.win, text = "Rub map against the wall",bg='#567', fg='White', command = lambda : self.incorrectInput(self.condition1, "CAUTION: The map is destroyed and you are stuck in the Pyramid! Restart!", "Rub map against the wall"))
    ...
    def Mission(self):
        ...
        self.finalButton1 = tk.Button(self.win, text="Byzantine coin",bg='#567', fg='White', command = lambda : self.gameEnd())
        self.finalButton2 = tk.Button(self.win, text="Coin shaped key",bg='#567', fg='White', command = lambda : self.incorrectInput(self.text5, "Incorrect item chosen!", "Coin shaped key"))
        self.text5 = tk.Label(self.win, text="",bg='black',fg='green')
        self.text6 = tk.Label(self.win, text="",bg='black',fg='green')
        self.text7 = tk.Label(self.win, text="",bg='black',fg='green')
